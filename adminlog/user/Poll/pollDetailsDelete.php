...
$qDelete="UPDATE poll_question SET Deletable=2 WHERE PollID=".$iDeleteID;
//echo $qDelete."<br>";
...
if($resultDelete){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'poll_question', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
