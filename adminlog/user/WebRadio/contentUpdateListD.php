...
<head>
<title>Web Radio - Update List (Bangla) Deleted</title>
...
<div class="DContent">
	...
	<tr><td align="right" colspan="8"><a href="contentInsert.php">Insert</a></td></tr>
	<tr><th colspan="8">Content - Update List (Bangla) Deleted </th></tr>
	<tr><td colspan="8" class="TdUpdateCat">
		...
		while($rsCategory=mysqli_fetch_assoc($resultCategory)){
			echo "<a href='contentUpdateListD.php?catid=".$rsCategory["CategoryID"]."&page=1'>".$rsCategory["CategoryName"]."</a>";
		}mysqli_free_result($resultCategory); ?>
		<a href="contentUpdateList.php" class="AEn ADel">Active Records</a>
	</td></tr>
	<tr><td align="center" valign="middle" colspan="8" class="TdSearch">
