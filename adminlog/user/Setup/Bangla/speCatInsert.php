...
<div class="DContent">
	...
	<table align="center" border="0" cellpadding="5" cellspacing="0" class="Tbl98">
		<tr><td align="right" valign="middle" colspan="2"><a href="speCatUpdateList.php">Update</a></td></tr>
		<tr><th colspan="2">Special Category - Insert (Bangla)</th></tr>
		<?php if(isset($_REQUEST["msg"])){ ?><tr><td colspan="2" class="TdDuplicate">Special Category Name Already exist. Please type a different Special Category Name.</td></tr><?php } ?>
		<tr>
			<td align="right" valign="middle">Special Category Name:</td>
			<td align="left" valign="top">
			<input type="text" id="txtSpecialCategoryName" name="txtSpecialCategoryName" maxlength="200" class="inpBN required" value="" required autofocus><?php echo $sMsgRequired; ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left" valign="top"><textarea id="txtEndNote" name="txtEndNote"></textarea></td>
		</tr>
		<tr>
