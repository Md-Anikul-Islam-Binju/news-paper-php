...
<div class="DContent">
	...
	<table align="center" border="0" cellpadding="5" cellspacing="0" class="Tbl98">
		...
		<tr><th colspan="2">Special Category - Update (Bangla)</th></tr>
		...
		<tr>
			...
			<td align="left">
			<input type="text" id="txtSpecialCategoryName" name="txtSpecialCategoryName" maxlength="20" class="inpBN required" value="<?php echo $rsUpdate["SpecialCategoryName"]; ?>" required autofocus><?php echo $sMsgRequired; ?>
			</td>
		</tr>
		<tr>
