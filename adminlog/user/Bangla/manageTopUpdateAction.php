...
if(isset($_POST["btnSubmit"])){
	$iCategory=1;$iTopHome=1;$iTopInner=1;$iSubCategoryID=1;$iSubCategoryIDPos=1;$iSpecialCategoryID=1;$iSpecialCategoryIDPos=1;$iDistrictID=1;
	...
	if(mysqli_query($connEMM, $qUpdate)){
		...
		VALUES('".$_SESSION["sessUserName"]."', 2, 'bn_content', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qUpdate)."', '".$dtDateTime."')";
