...
<div class="DContent">
	...
	<tr>
		...
		<td align="left" valign="top">
			...
			Inner Page: <select name="cboTopInner">
				...
				<option value="3" <?php if($rsUpdate["TopInner"]==3){echo "selected='selected'";} ?>>List</option>
	...
	<tr>
		...
		<td align="left" valign="top">
		<input type="text" name="txtInitial" value="<?php echo $rsUpdate["Initial"]; ?>">&nbsp;
		Source: <input type="text" name="txtSource" value="<?php echo $rsUpdate["Source"]; ?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		if($rsUpdate["ImageThumbPath"]==""){$_SESSION["sessImageThumbPathEN"]="";}else{$_SESSION["sessImageThumbPathEN"]=$rsUpdate["ImageThumbPath"];} ?>
