...
<div class="DContent">
	...
	<form name="frmInsert" id="frmInsert" method="post" action="contentInsertAction.php" enctype="multipart/form-data" onsubmit="return checkLength();">
	<table align="center" border="0" cellpadding="5" cellspacing="0" class="Tbl98">
	<tr><td align="right" valign="middle" colspan="2"><a href="contentUpdateList.php">Update</a></td></tr>
	...
	<tr>
		...
		<td align="left" valign="top">
			...
			<?php while($rsDistrict=mysqli_fetch_assoc($resultDistrict)){ ?>
				<option value="<?php echo $rsDistrict["DistrictID"]; ?>" <?php if($rsDistrict["DistrictID"]==11){echo " selected='selected'";} ?>><?php echo $rsDistrict["DistrictName"]; ?></option>
	...
	<tr>
		...
		<td align="left" valign="top">
		<input type="text" name="txtInitial" class="" value="<?php echo $sInitialBN; ?>">&nbsp;
		Source: <input type="text" name="txtSource" class="" value="">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left" valign="middle">
			...
			<!-- div class="DFloating2">
			Previous Content ID:
			<input type="number" id="txtPrevContentID" name="txtPrevContentID" class="required" value="0"><?php //echo $sMsgRequired.$sMsgNumber; ?>
			</div -->
		</td>
	</tr>
