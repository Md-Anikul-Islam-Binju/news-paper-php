...
<head>
<title>Sub Category Content - Update List (Bangla) Deleted</title>
...
<div class="DContent">
	...
	<tr><th colspan="8">Sub Category - Update List (Bangla) Deleted </th></tr>
	<tr><td colspan="8" class="TdUpdateCat">
		<a href="subContentUpdateListD.php?subcatid=0&page=1" class="AEn">ALL</a>
		...
		while($rsCategory=mysqli_fetch_assoc($resultCategory)){
			echo "<a href='subContentUpdateListD.php?subcatid=".$rsCategory["SubCategoryID"]."&page=1'>".$rsCategory["SubCategoryName"]."</a>";
		}mysqli_free_result($resultCategory); ?>
		<a href="subContentUpdateList.php" class="AEn ADel">Regular Records</a>
	</td></tr>
	<tr><td colspan="8" class="TdSearch">
	<form name="frmContentID" action="subContentUpdateListD.php" method="post">
