...
if(isset($_POST["btnSubmit"])){
	...
	$qUpdate="UPDATE bn_breaking SET BreakingHead='".$sBreakingHead."' WHERE BreakingID=".$iUpdateID;
	//echo $qUpdate."<br>";
	...
	if(mysqli_query($connEMM, $qUpdate)){
		...
		VALUES('".$_SESSION["sessUserName"]."', 2, ".$iUpdateID.", 'bn_breaking', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qUpdate)."', '".$dtDateTime."')";
