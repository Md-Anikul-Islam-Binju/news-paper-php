...
$qDelete="UPDATE bn_content SET Deletable=2 WHERE ContentID=".$iDeleteID;
//echo $qDelete."<br>";
$resultDelete=mysqli_query($connEMM, $qDelete) or die(mysqli_error($connEMM));

//Collecting parameter value
$qShow="SELECT CategoryID, SpecialCategoryID,SubCategoryID FROM bn_content WHERE ContentID=".$iDeleteID;
