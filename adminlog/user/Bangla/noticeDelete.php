...
$qDelete="UPDATE bn_notice SET Deletable=2 WHERE NoticeID=".$iDeleteID;
//echo $qDelete."<br>";
...
if($resultDelete){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'bn_notice', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
