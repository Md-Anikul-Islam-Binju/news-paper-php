...
<head>
<title>Special Category - Update List (Bangla)</title>
...
<div class="DContent">
	...
	<form name="frmContentID" action="speContentUpdateList.php" method="post">
	...
	if($iSpeCategoryID>0){$qCoutner="SELECT COUNT(ContentID) AS numrows FROM bn_content WHERE SpecialCategoryID=".$iSpeCategoryID." AND Deletable=1";
