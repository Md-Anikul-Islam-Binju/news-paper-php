...
if(isset($_POST["btnSubmit"])){
	...
	$qUpdate="UPDATE bn_tag SET TagName='".$sTagName."', TagActive=".$iTagActive." WHERE TagID=".$iUpdateID;
	//echo $qUpdate."<br>";
	...
	if(mysqli_query($connEMM, $qUpdate)){
		...
		VALUES('".$_SESSION["sessUserName"]."', 2, ".$iUpdateID.", 'bn_tag', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qUpdate)."', '".$dtDateTime."')";
