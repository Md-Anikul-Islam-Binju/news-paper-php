...
$qDelete="UPDATE bn_scroll SET Deletable=2 WHERE ScrollID=".$iDeleteID;
//echo $qDelete."<br>";
...
if($resultDelete){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'bn_scroll', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
