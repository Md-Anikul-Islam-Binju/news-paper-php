...
<div class="DContent">
	...
	<tr><td align="right" valign="middle" colspan="5"><a href="contentInsert.php">Insert</a></td></tr>
	...
	<tr><td colspan="5" class="TdSearch">
	...
	<div class="DCategory"><a href="contentUpdateList.php?catid=<?php echo $rsContent["CategoryID"]; ?>&page=1" class="bn"><?php echo $rsContent["CategoryName"]; ?></a></div>
	<div class="DSubSpeCategory">
	Sub Category: <a href="subContentUpdateList.php?subcatid=<?php echo $rsContent["SubCategoryID"]; ?>&page=1" class="bn"><?php echo $rsContent["SubCategoryName"]; ?></a>
	Top: <?php echo $rsContent["SubCategoryIDPos"]-1; ?>
	</div>
	<div class="DSubSpeCategory">
	Special Category: <a href="speContentUpdateList.php?specatid=<?php echo $rsContent["SpecialCategoryID"]; ?>&page=1" class="bn"><?php echo $rsContent["SpecialCategoryName"]; ?></a>
