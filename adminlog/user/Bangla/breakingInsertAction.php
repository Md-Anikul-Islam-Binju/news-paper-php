...
if(isset($_POST["btnSubmit"])){
	...
	$sBreakingHead=fFormatString($_POST["txtBreakingHead"]);
	$qInsert="INSERT INTO bn_breaking(BreakingHead, DateTimeInserted) VALUES ('".$sBreakingHead."', '".$dtDateTime."')";
	//echo $qInsert."<br>";
	...
	if(mysqli_query($connEMM, $qInsert)){
		...
		VALUES('".$_SESSION["sessUserName"]."', 1, ".$iThisContentID.", 'bn_breaking', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qInsert)."', '".$dtDateTime."')";
