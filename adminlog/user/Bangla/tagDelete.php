...
$qDelete="UPDATE bn_tag SET Deletable=2 WHERE TagID=".$iDeleteID;
//echo $qDelete."<br>";
...
if(mysqli_query($connEMM, $qDelete)){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'bn_tag', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
