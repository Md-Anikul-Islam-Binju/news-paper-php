...
<head>
<title>Access to Control Panel by IP (Common - Bangla)</title>
...
<body>
<?php include_once($sAdmnPath."common/header.php"); ?>
...
<div class="DContent">
	...
	<tr><th colspan="8">Access to Control Panel by IP (Common - Bangla)</th></tr>
	<tr class="TrHeadings">
		<th>ID</th>
		<th>User Info</th>
		<th>Action Type</th>
	...
	<?php $resultContent=mysqli_query($connEMMAudit, "SELECT AuditTrailID, UserInfo, ActionType, TableName, RemoteIP, RequestFileName, QueryDetails, DateTimeOccered FROM com_audittrail_gen_bn GROUP BY RemoteIP ORDER BY RemoteIP ASC") or die(mysqli_error($connEMMAudit));
