...
<head>
<title>Access to Control Panel by IP (Common - English)</title>
...
<div class="DContent">
	...
	<tr><th colspan="8">Access to Control Panel by IP (Common - English)</th></tr>
	<tr class="TrHeadings">
		<th>ID</th>
		<th>User Info</th>
		<th>Action Type</th>
	...
	<?php $resultContent=mysqli_query($connEMMAudit, "SELECT AuditTrailID, UserInfo, ActionType, TableName, RemoteIP, RequestFileName, QueryDetails, DateTimeOccered FROM com_audittrail_gen_en GROUP BY RemoteIP ORDER BY RemoteIP ASC") or die(mysqli_error($connEMMAudit));
