...
<head>
<title>Access to Control Panel by IP (Photo)</title>
...
<div class="DContent">
	...
	<tr><th colspan="8">Access to Control Panel by IP (Photo)</th></tr>
	<tr class="TrHeadings">
		<th>ID</th>
		<th>User Info</th>
		<th>Action Type</th>
	...
	<?php $resultContent=mysqli_query($connEMMAudit, "SELECT AuditTrailID, UserInfo, ActionType, TableName, RemoteIP, RequestFileName, QueryDetails, DateTimeOccered FROM com_audittrail_photo GROUP BY RemoteIP ORDER BY RemoteIP ASC") or die(mysqli_error($connEMMAudit));
