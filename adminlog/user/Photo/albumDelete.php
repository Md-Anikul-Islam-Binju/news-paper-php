...
$qDelete="UPDATE p_album SET Deletable=2 WHERE AlbumID=".$iDeleteID;
//echo $qDelete."<br>";
...
if(isset($resultDelete)){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'p_album', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
