...
if(isset($_POST["btnSubmit"])){
	...
	$qInsert="INSERT INTO p_manual_photo(ImagePath) VALUES ('".$sImageSMPathNew."')";
	//echo $qInsert."<br><br>";
	...
	if(isset($resultInsert)){
		...
		VALUES('".$_SESSION["sessUserName"]."', 1, ".$iThisContentID.", 'p_manual_photo', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qInsert)."', '".$dtDateTime."')";
					...
					while($fileRen=readdir($dir)){
						if($fileRen==$sImageSMPath){
							...
							if($iFlag==1){
								...
								$qUpdate="UPDATE p_manual_photo SET ImagePath='".$sNewName."' WHERE MannualImageID=".$iThisContentID;
