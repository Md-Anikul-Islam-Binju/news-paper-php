...
$qDelete="UPDATE p_photo SET Deletable=2 WHERE PhotoID=".$iDeleteID;
//echo $qDelete."<br>";
...
if(isset($resultDelete)){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'p_photo', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
	mysqli_query($connEMMAudit, $qAuditTrail) or die($sMsgAuTrailInsert);

	echo $sMsgDelete;
	$_SESSION["sessRedirectPage"]=$_SESSION["sessRedirectDailyPhoto"];
