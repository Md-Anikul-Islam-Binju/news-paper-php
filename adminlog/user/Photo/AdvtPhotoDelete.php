...
$qDelete="UPDATE p_advt SET Deletable=2 WHERE AdvtImageID=".$iDeleteID;
//echo "SQL: ".$qDelete."<br>";
...
if(isset($resultDelete)){
    ...
    VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'p_advt', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
