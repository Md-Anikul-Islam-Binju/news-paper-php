...
$qDelete="UPDATE p_manual_photo SET Deletable=2 WHERE MannualImageID=".$iDeleteID;
//echo "SQL: ".$qDelete."<br>";
...
if(isset($resultDelete)){
	...
	VALUES('".$_SESSION["sessUserName"]."', 3, ".$iDeleteID.", 'p_manual_photo', '".$_SERVER["REMOTE_ADDR"]."', '".$_SERVER["REQUEST_URI"]."', '".fAuTrail($qDelete)."', '".$dtDateTime."')";
